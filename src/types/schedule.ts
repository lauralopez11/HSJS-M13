...
export declare type Status = 'idle' | 'loading' | 'error' | 'success';
...
export interface Handlers {
  ...
  handleAddEvent: (event: EventWithParticipantIds) => void;
  handleUpdateEvent: (event: EventWithParticipantIds, id: string) => void;
